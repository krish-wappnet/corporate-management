...
export class FeedbackController {
  ...
  @Get('360/:userId/summary')
  @ApiOperation({ summary: 'Get 360 feedback summary for a user' })
  @ApiResponse({ status: 200, description: 'Feedback summary retrieved successfully' })
  ...
  @Get('analytics/ratings/:userId')
  @ApiOperation({ summary: 'Get average feedback ratings for a user' })

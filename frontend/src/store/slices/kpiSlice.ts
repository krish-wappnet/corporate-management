...
>(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(typeof errorMessage === 'string' ? errorMessage : 'Failed to fetch categories');
    }
  }
);
...
>(
  ...
  async ({ id, name, description }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(typeof errorMessage === 'string' ? errorMessage : 'Failed to update category');
    }
  }
);
...
>(
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(typeof errorMessage === 'string' ? errorMessage : 'Failed to delete category');
    }
  }
);
...
>(
  ...
  async (categoryData, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(typeof errorMessage === 'string' ? errorMessage : 'Failed to create category');
    }
  }
);
...
>('kpi/fetchKpiUpdates', async (kpiId, { rejectWithValue }) => {
  try {
    ...
    return rejectWithValue(error.response?.data?.message || 'Failed to fetch KPI updates');
  }
});
...
>('kpi/addKpiUpdate', async (updateData, { rejectWithValue }) => {
  try {
    ...
    return rejectWithValue(error.response?.data?.message || 'Failed to add KPI update');
  }
});
